...
Para o teste realizado, foram consideradas 300 identidades com \textit{embeddings} válidos no conjunto de referência. Uma identidade foi selecionada como consulta, e seu embedding foi comparado com os \textit{embeddings} das demais identidades por meio da distância cosseno. O processo de identificação consistiu em selecionar a identidade que apresentou a menor distância em relação à consulta, caracterizando o candidato mais próximo no espaço de \textit{embeddings}.
