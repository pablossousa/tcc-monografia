...
Com o intuito de organizar adequadamente os experimentos e evitar sobreposição de identidades entre diferentes fases de avaliação, o conjunto de desenvolvimento foi consolidado em um único arquivo, no qual cada registro inclui um atributo adicional que indica a qual subconjunto a identidade pertence (treino, validação ou teste), respeitando a divisão previamente definida de 240, 30 e 30 identidades, respectivamente.
