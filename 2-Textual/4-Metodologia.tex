...
Com o intuito de organizar adequadamente os experimentos e evitar sobreposição de identidades entre diferentes fases de avaliação, o cadastro foi dividido em um arquivo \acs{JSON}. O arquivo corresponde ao conjunto de desenvolvimento, contendo as identidades destinadas às etapas de treino, validação e teste. Nesse arquivo, cada registro inclui um atributo adicional que indica a qual subconjunto a identidade pertence (treino, validação ou teste), respeitando a divisão previamente definida de 240, 30 e 30 identidades, respectivamente.
