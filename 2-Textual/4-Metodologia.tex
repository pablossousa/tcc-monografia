...
Este trabalho adota uma metodologia experimental com o objetivo de avaliar a viabilidade tecnológica do uso de reconhecimento facial como alternativa ao controle de acesso baseado em cartões \acs{NFC}, no contexto acadêmico do \acs{CEFET-MG}. A abordagem proposta fundamenta-se no paradigma de aprendizado métrico em espaço de \textit{embeddings}, amplamente discutido na literatura de aprendizado profundo, incluindo estratégias baseadas em redes siamesas e funções de perda do tipo \textit{triplet loss}, conforme apresentado por Andrew Ng \cite{ng2021deeplearning}.
